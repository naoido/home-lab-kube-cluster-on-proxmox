...
VM_LIST=(
    ...
    "1001 k8s-cp-1 4    7168  192.168.1.11 192.168.1.1 raspberrypi-proxmox-01"
    "1002 k8s-cp-2 4    7168  192.168.1.12 192.168.1.2 raspberrypi-proxmox-02"
    "1003 k8s-cp-3 4    7168  192.168.1.13 192.168.1.3 raspberrypi-proxmox-03"
    ...
    "1104 k8s-wk-5 4    8192  192.168.1.24 192.168.1.7 core-proxmox-01"
)
