...
# clone repo
git clone -b main --no-recurse-submodules https://naoido:$GITHUB_PAT@github.com/naoido/home-lab-kube-cluster-on-proxmox.git "$HOME"/home-lab-kube-cluster-on-proxmox
cd "$HOME"/home-lab-kube-cluster-on-proxmox
git clone https://naoido:$GITHUB_PAT@github.com/naoido/home-lab-kube-cluster-on-proxmox-secrets.git k8s-manifests/secrets
